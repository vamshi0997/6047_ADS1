...
class Team implements Comparable<Team> {
    ...
    private int losses;
    /**
     * Team Constructs the object.
     *
     * @param      teamname1  The teamname 1
     * @param      wins1      The wins 1
     * @param      losses1    The losses 1
     * @param      draws1     The draws 1
     */
    Team(final String teamname1,
        final int wins1, final int losses1, final int draws1) {
...
class Teams {
     ...
     * sort method is used to sort the team object
     * by sending it to Insertion sort.
...
class InsertionSort {
     ...
     */
    public boolean less(
        final Team[] team, final int first, final int next) {
